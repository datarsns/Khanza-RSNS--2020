    ...
    <div class="entry">        
        ...
        <table width="100%" align="center">
            ...
            <tr class="head">
                ...
                <td width="67%">
                    <input name="kelas_rawat" class="text3" onkeydown="setDefault(this, document.getElementById('MsgIsi2'));" type=text id="TxtIsi1" class="inputbox" value="<?php echo getOne("select no_sep from bridging_sep where no_rawat='$norawat'")?>" size="40" maxlength="40">
                ...
                <td width="67%">
                    <select name="kelas_rawat" class="text3">
                        <?php if($status_lanjut=="Ralan"){
                            ...
                            if(getOne("select klsrawat from bridging_sep where no_rawat='".$norawat."'")='3'){
                                echo "<option value='3'>Kelas 3</option>";
                            }else if(getOne("select klsrawat from bridging_sep where no_rawat='".$norawat."'")='2'){
                                echo "<option value='2'>Kelas 2</option>";
                            }else if(getOne("select klsrawat from bridging_sep where no_rawat='".$norawat."'")='1'){
