...
public class DlgPemesanan extends javax.swing.JDialog {
    ...
    public DlgPemesanan(java.awt.Frame parent, boolean modal) {
        ...
        form.petugas.getTable().addKeyListener(new KeyListener() {
            @Override
            public void keyTyped(KeyEvent e) {}
            @Override
            public void keyPressed(KeyEvent e) {
    ...
    private void initComponents() {
        ...
        nmptg.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nmptgActionPerformed(evt);
            }
        });
        panelisi3.add(nmptg);
...
private void kdptgKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdptgKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select user_nama from user_detail where nip=?", nmptg,kdptg.getText());          
        }else if(evt.getKeyCode()==KeyEvent.VK_PAGE_UP){
...
private void btnGudangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGudangActionPerformed
    ...
    private void nmptgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nmptgActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_nmptgActionPerformed
