...
public final class RMDataAsuhanGizi extends javax.swing.JDialog {
    ...
    private String alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, alergi_ikan, alergi_hazelnut, Lainnya, AsuhanKategori;
    ...
    public RMDataAsuhanGizi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "ULNA(Cm)","BB Ideal(Kg)","BB/U(SD)","TB/U(SD)","BB/TB(SD)","LiLA/U(SD)","Kategori","Biokimia","Fisik/Klinis","Telur","Susu Sapi",
            "Kacang","Gluten","Udang","Ikan","Hazelnut","Lainnya","Pola Makan","Riwayat Personal","Diagnosis Gizi","Intervensi Gizi",
        ...
        FisikKlinis1.setDocument(new batasInput((int)100).getKata(FisikKlinis1));
    ...
    private void initComponents() {
        ...
        FisikKlinis1 = new widget.TextBox();
        jLabel53 = new widget.Label();
        Kategori = new widget.TextBox();
        jScrollPane1 = new javax.swing.JScrollPane();
        AlergiLainnya = new widget.TextArea();
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-02-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-02-2020" }));
        ...
        label14.setBounds(-20, 640, 130, 23);
        ...
        KdPetugas.setBounds(120, 640, 130, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setName("NmPetugas"); // NOI18N
        NmPetugas.setPreferredSize(new java.awt.Dimension(207, 23));
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(260, 640, 300, 23);
        ...
        BtnDokter.setBounds(560, 640, 28, 23);
        ...
        jLabel28.setBounds(610, 150, 70, 23);
        ...
        PolaMakan.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        PolaMakan.setBounds(150, 490, 615, 23);

        jLabel38.setText("Riwayat Personal :");
        jLabel38.setName("jLabel38"); // NOI18N
        FormInput.add(jLabel38);
        jLabel38.setBounds(-20, 520, 130, 23);
        ...
        DiagnosisGizi.setBounds(120, 550, 645, 23);

        jLabel40.setText("Diagnosis Gizi :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(-20, 550, 130, 23);

        jLabel41.setText("Intervensi Gizi :");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(-20, 580, 130, 23);
        ...
        IntervensiGizi.setBounds(120, 580, 645, 23);

        jLabel42.setText("Monitoring & Evaluasi :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 610, 120, 23);
        ...
        Monitoring.setBounds(120, 610, 645, 23);
        ...
        jLabel44.setBounds(-20, 490, 160, 23);
        ...
        jLabel50.setText("Lainnya :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(-20, 370, 160, 23);

        RiwayatPersonal.setFocusTraversalPolicyProvider(true);
        RiwayatPersonal.setName("RiwayatPersonal"); // NOI18N
        RiwayatPersonal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RiwayatPersonalActionPerformed(evt);
            }
        });
        ...
        RiwayatPersonal.setBounds(120, 520, 645, 23);

        jLabel52.setText("Alergi Makanan :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(0, 260, 160, 23);

        FisikKlinis1.setFocusTraversalPolicyProvider(true);
        FisikKlinis1.setName("FisikKlinis1"); // NOI18N
        FisikKlinis1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                FisikKlinis1KeyPressed(evt);
            }
        });
        FormInput.add(FisikKlinis1);
        FisikKlinis1.setBounds(134, 210, 645, 23);

        jLabel53.setText("BB/U :");
        jLabel53.setName("jLabel53"); // NOI18N
        FormInput.add(jLabel53);
        jLabel53.setBounds(649, 120, 40, 23);
        ...
        Kategori.setBounds(690, 150, 100, 24);

        jScrollPane1.setName("jScrollPane1"); // NOI18N

        AlergiLainnya.setColumns(20);
        AlergiLainnya.setRows(5);
        AlergiLainnya.setName("Lainnya"); // NOI18N
        AlergiLainnya.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                AlergiLainnyaKeyPressed(evt);
            }
        });
        jScrollPane1.setViewportView(AlergiLainnya);

        FormInput.add(jScrollPane1);
        jScrollPane1.setBounds(150, 370, 610, 110);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
        ...
        }else if(FisikKlinis1.getText().trim().equals("")){
            Valid.textKosong(FisikKlinis1,"Fisik/Klinis");
        ...
        }else if(AlergiLainnya.getText().trim().equals("")){
            Valid.textKosong(AlergiLainnya,"Lainnya");
            ...
            if(Sequel.menyimpantf("asuhan_gizi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",30,new String[]{
                    ...
                    Biokimia.getText(),FisikKlinis1.getText(), alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, 
                    alergi_ikan, alergi_hazelnut, PolaMakan.getText(),RiwayatPersonal.getText(),DiagnosisGizi.getText(),IntervensiGizi.getText(),
                    Monitoring.getText(),KdPetugas.getText(), AlergiLainnya.getText(),Kategori.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                ...
                if(Sequel.mengedittf("asuhan_gizi","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,antropometri_bb=?,antropometri_tb=?,antropometri_imt=?,antropometri_lla=?,antropometri_tl=?,antropometri_ulna=?,antropometri_bbideal=?,antropometri_bbperu=?,antropometri_tbperu=?,antropometri_bbpertb=?,antropometri_llaperu=?,kategori?,biokimia=?,fisik_klinis=?,alergi_telur=?,alergi_susu_sapi=?,alergi_kacang=?,alergi_gluten=?,alergi_udang=?,alergi_ikan=?,alergi_hazelnut=?,lainnya=?,pola_makan=?,riwayat_personal=?,diagnosis=?,intervensi_gizi=?,monitoring_evaluasi=?,nip=?",33,new String[]{
                        TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+""),BB.getText(),TB.getText(),IMT.getText(),LiLA.getText(), 
                        TL.getText(),ULNA.getText(),BBIdeal.getText(),BBPerU.getText(),TBPerU.getText(),BBPerTB.getText(),LiLAPerU.getText(), 
                        Kategori.getText(),Biokimia.getText(),FisikKlinis1.getText(), alergi_telur, alergi_susu_sapi, alergi_kacang, alergi_gluten, alergi_udang, 
                        alergi_ikan, alergi_hazelnut, AlergiLainnya.getText(), PolaMakan.getText(),RiwayatPersonal.getText(),DiagnosisGizi.getText(),IntervensiGizi.getText(),
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptDataAsuhanGiziPasien.jasper","report","::[ Data Asuhan Gizi Pasien ]::",
                        ...
                        "asuhan_gizi.diagnosis,asuhan_gizi.intervensi_gizi,asuhan_gizi.monitoring_evaluasi,asuhan_gizi.nip,petugas.nama,asuhan_gizi.lainnya,asuhan_gizi.kategori"+
    ...
    private void MnAsuhanGiziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAsuhanGiziActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakAsuhanGizi.jasper","report","::[ Laporan Asuhan Gizi Pasien ]::",
                        ...
                        "asuhan_gizi.antropometri_bb,asuhan_gizi.antropometri_tb,asuhan_gizi.antropometri_imt,asuhan_gizi.antropometri_lla,"+
                        "asuhan_gizi.antropometri_tl,asuhan_gizi.antropometri_ulna,asuhan_gizi.antropometri_bbideal,asuhan_gizi.antropometri_bbperu,"+
                        "asuhan_gizi.antropometri_tbperu,asuhan_gizi.antropometri_bbpertb,asuhan_gizi.antropometri_llaperu,asuhan_gizi.kategori,asuhan_gizi.biokimia,"+
                        "asuhan_gizi.fisik_klinis,asuhan_gizi.alergi_telur,asuhan_gizi.alergi_susu_sapi,asuhan_gizi.alergi_kacang,asuhan_gizi.alergi_gluten,"+
                        "asuhan_gizi.alergi_udang,asuhan_gizi.alergi_ikan,asuhan_gizi.alergi_hazelnut,asuhan_gizi.pola_makan,asuhan_gizi.riwayat_personal,"+
                        "asuhan_gizi.diagnosis,asuhan_gizi.intervensi_gizi,asuhan_gizi.monitoring_evaluasi,asuhan_gizi.nip,asuhan_gizi.lainnya,petugas.nama,reg_periksa.umurdaftar,reg_periksa.sttsumur, penjab.png_jawab "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join asuhan_gizi on reg_periksa.no_rawat=asuhan_gizi.no_rawat "+
    ...
    private void BiokimiaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BiokimiaKeyPressed
        Valid.pindah(evt,LiLAPerU,AlergiLainnya);
    ...
    private void PolaMakanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PolaMakanKeyPressed
        Valid.pindah(evt,AlergiLainnya,RiwayatPersonal);
    ...
    private void RiwayatPersonalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RiwayatPersonalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_RiwayatPersonalActionPerformed

    private void FisikKlinis1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FisikKlinis1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_FisikKlinis1KeyPressed
    ...
    */
    ...
    private widget.TextArea AlergiLainnya;
    ...
    private widget.TextBox FisikKlinis1;
        ...
        try{
            ...
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "asuhan_gizi.antropometri_tbperu,asuhan_gizi.antropometri_bbpertb,asuhan_gizi.antropometri_llaperu,asuhan_gizi.kategori,asuhan_gizi.biokimia,"+
                        "asuhan_gizi.fisik_klinis,asuhan_gizi.alergi_telur,asuhan_gizi.alergi_susu_sapi,asuhan_gizi.alergi_kacang,asuhan_gizi.alergi_gluten,"+
                        "asuhan_gizi.alergi_udang,asuhan_gizi.alergi_ikan,asuhan_gizi.alergi_hazelnut,asuhan_gizi.lainnya,asuhan_gizi.pola_makan,asuhan_gizi.riwayat_personal,"+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kategori"),rs.getString("biokimia"),rs.getString("fisik_klinis"),rs.getString("alergi_telur"),rs.getString("alergi_susu_sapi"),
                        rs.getString("alergi_kacang"),rs.getString("alergi_gluten"),rs.getString("alergi_udang"),rs.getString("alergi_ikan"),
                        rs.getString("alergi_hazelnut"),rs.getString("lainnya"),rs.getString("pola_makan"),rs.getString("riwayat_personal"),rs.getString("diagnosis"),
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Kategori.setText(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            Biokimia.setText(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());         
            FisikKlinis1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),19).toString());
            ...
            PolaMakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            RiwayatPersonal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            DiagnosisGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString()); 
            IntervensiGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString()); 
            Monitoring.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
            KdPetugas.setText(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString());
            NmPetugas.setText(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString());
...
//            Sequel.cariIsi("select user_nama from user_detail where id_user=?", NmPetugas,KdPetugas.getText());
