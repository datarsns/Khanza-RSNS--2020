            ...
            if(no_peserta.trim().equals("")){
                ...
                if(cekViaBPJSKartu.informasi.equals("OK")){
                    if(cekViaBPJSKartu.statusPesertaketerangan.equals("AKTIF")){
                        ...
                        NoSKDP.setText(TNoRw.getText().toString().substring(13, TNoRw.getText().length()));
                        /*
                        KdPenyakit.setText(cekViaBPJSKartu.kodePenyakit);
                        NmPenyakit.setText(cekViaBPJSKartu.namaPenyakit);
                        KdPoli.setText(cekViaBPJSKartu.kodePoli);
                        NmPoli.setText(cekViaBPJSKartu.namaPoli);
                        */
                        
                        if(Rawat.equalsIgnoreCase("Jalan")){
                            AsalRujukan.setSelectedIndex(0);
                            NoRujukan.requestFocus();
                        }else if(Rawat.equalsIgnoreCase("Inap")){
                            AsalRujukan.setSelectedIndex(1);
                            KdPpkRujukan.setText("0159R009");
                            NmPpkRujukan.setText("RSU NURUSSYIFA - KAB. KUDUS");
                            JenisPelayanan.setSelectedIndex(0);
                            NoRujukan.setText(TNoRw.getText().toString());
                        }
//                        NoRujukan.requestFocus();                                               
                    }else{
                     ...
                     if(JenisPelayanan.getSelectedIndex()==1){
                        /*try {
                            ...
                            if(nameNode.path("code").asText().equals("200")){*/
                                ...
                                emptTeks();
                                JOptionPane.showMessageDialog(null,"Simpan SEP Berhasil");
                                tampil();     
                            /*}else{
                                JOptionPane.showMessageDialog(null,nameNode.path("message").asText());
                            }
